...
const passengers = [2182856, 2249783, 2818148, 2930447, 3092419, 3088289, 3170540, 3211932, 2811725, 3075491, 2705211, 2761947];
const flights = [24717, 23464, 27831, 28535, 29917, 29733, 30529, 31947, 29714, 31074, 28445, 27872];
...
series: [
  {
    name: "Passengers",
    data: normalizeData(passengers)
  },
  {
    name: "Flights",
    data: normalizeData(flights)
  }
],
options: {
  chart: {
...
export default function PssengerVsFlight19() {
return (
    ...
    >
      <div className="ml-4">
        <Typography variant="h6" color="black" className="text-2xl font-bold">
          Passengers and Flights in 2019
        </Typography>
        <Typography
          variant="small"
          color="gray"
